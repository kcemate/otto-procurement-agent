...
def main():
    ...
    cmd=['hermes','chat','--provider','moa','-m','nvidia-hackathon','-Q','--max-turns','1','--ignore-rules','-q',prompt]
    raw=''
    try:
